...
public class JSTreeOnSelectDirective
		extends AngularDirectiveBase<JSTreeOnSelectDirective>
{
	/**
	 * Constructs a new right click directive based on the angular object passed in
	 */
	public JSTreeOnSelectDirective()
	{
		super("ngJstreeOnSelect");
	}
	...
	{
		return FileTemplates.getFileTemplate(JSTreeOnSelectDirective.class, "JSTreeOnSelectPlugin", "JSTreeOnSelectDirective.min.js")
		                    .toString();
	}
